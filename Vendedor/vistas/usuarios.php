<?php 
session_start();
if(isset($_SESSION['usuario']) and $_SESSION['usuario']=='Superuser123'){
	?>
	<!DOCTYPE html>
	<html>
	<head>
				...
				<div class="col-sm-4">
					<form id="frmRegistro">
						...
						<select class="form-control input-sm" name="rol" id="rol">
						    <option value="A">Selecciona Tipo Usuario</option>
							<option value="vendedor"> Vendedor</option>
							<option value="repartidor"> Repartidor</option>
							<option value="gestorpersonal"> Gestor personal</option>
						</select>
						<p></p>
